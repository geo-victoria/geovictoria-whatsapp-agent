...
async function paisFlow(contact: string): Promise<"cl" | "pe" | "co" | "mx"> {
  ...
  return NextResponse.json({
    ...
    prefill: {
      ...
      etiqueta_admin_documento_ayuda:
        b.pais === "pe" ? "8 dígitos. Ej: 12345678 (o carné de extranjería)" : b.pais === "co" ? "Cédula de ciudadanía. Ej: 1234567890" : b.pais === "mx" ? "18 caracteres. Ej: GOMA800101HDFRRN09" : b.pais === "cl" ? "Ej: 12.345.678-9" : "",
      etiqueta_zona: b.pais === "pe" ? "Distrito" : b.pais === "co" ? "Ciudad" : b.pais === "mx" ? "Alcaldía o municipio" : "Comuna",
      ...
      mostrar_campos_empresa: !natural && b.pais !== "pe" && b.pais !== "co" && b.pais !== "mx",
...
function mensajeError(campo: string, pais: "cl" | "pe" | "co" | "mx" = "cl"): string {
  switch (campo) {
    case "empresa.identificador":
      return pais === "pe" ? "RUC inválido — son 11 dígitos, revísalo" : pais === "co" ? "NIT inválido — revísalo (ej: 900123456-7)" : pais === "mx" ? "RFC inválido — revísalo (ej: ABC010203AB1)" : "RUT inválido — revisa el dígito verificador"
    case "admin.identificador":
      return pais === "pe" ? "DNI inválido — son 8 dígitos (o tu carné de extranjería)" : pais === "co" ? "Cédula inválida — revísala" : pais === "mx" ? "CURP inválida — son 18 caracteres" : "RUT inválido — revisa el dígito verificador"
    case "admin.email":
