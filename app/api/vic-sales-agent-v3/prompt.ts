...
¿Cuál te acomoda más para tu operación? También puedes elegirlas todas si prefieres."
   ...
   - Reloj físico → punto fijo donde se concentra personal (central, planta, local). NUNCA lo listes solo: en un punto fijo va acompañado de la cuadrilla (ver regla dura de arriba).
