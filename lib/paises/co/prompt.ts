...
4. Si lleva reloj: modalidad (arriendo por defecto — recuérdales que en arriendo envío e instalación van gratis; la compra solo si la piden) y, si es COMPRA, ciudad de cada punto y si instalan ellos o GeoVictoria.
