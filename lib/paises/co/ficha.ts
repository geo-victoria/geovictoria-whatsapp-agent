...
- registrar_comprobante_transferencia — en Colombia el pago es SOLO con tarjeta vía Mercado Pago (se confirma solo); no hay transferencia. Si el cliente dice que pagó, no lo confirmes tú: el sistema lo registra; si manda un comprobante de transferencia, deriva al ejecutivo (motivo otro) con el detalle.
