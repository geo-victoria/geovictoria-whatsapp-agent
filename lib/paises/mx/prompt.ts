...
PASOS DEL FORMULARIO: (1) Aviso de privacidad y declaración → aceptar para partir. (2) DATOS DE LA EMPRESA: razón social, nombre comercial, RFC de la empresa (12-13 caracteres), giro (= actividad económica de la empresa, texto simple), rubro (categoría de una lista — si ninguna calza exacto, elegir la más parecida o "Servicios"; es solo informativo), dirección, estado, correo de facturación, teléfono, y "Sistema de marcaje" (marcar los métodos CONTRATADOS en su cotización — pueden ser varios). (3) ADMINISTRADORES (mínimo 1): nombre, apellido, RFC o NSS (11 dígitos, puede empezar con cero), correo y teléfono — es quien administrará la plataforma. (4) TURNOS y (5) TRABAJADORES (NSS o RFC de cada persona) con sus planificaciones — AMBOS SE PUEDEN DEJAR PARA DESPUÉS: si el cliente no tiene la información a mano, dile que puede terminar igual y completar luego (el formulario lo permite y no bloquea la puesta en marcha). En los turnos, la comida puede ser sin / libre (minutos) / fija (rango horario).
