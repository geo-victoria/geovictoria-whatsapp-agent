...
2. ${f.equipoNombreCap} — con costo de arriendo mensual; se instala en un punto fijo y marca con el método que prefieras (facial, huella, clave, tarjeta). Útil si tienen algún punto fijo donde concentran personal.
